...
DOWNLOAD_URI = 'https://github.com/nisavid/spruce-pkg'
...
STD_SCRIPTS_PKG_COMMANDS = {'find-devel-pyprojects':
                                ('find_pyprojects',
                                 'main_using_devel_projects'),
                            'find-pyprojects': 'find_pyprojects',
                            'sort-devel-pyproject-deps':
                                ('sort_pyproject_deps',
                                 'main_using_devel_projects'),
                            'sort-pyproject-deps': 'sort_pyproject_deps',
                            }
